...
==== Database Creation
[TODO]
To allow initial access to the system, running _rake db:seed_ which will create and _admin_ user with the password _password_.  This user should be used to set up another admin user, then deleted.
