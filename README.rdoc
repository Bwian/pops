...
Remote access to SQL Server is usually not enabled by default.  Here are some set up hints for SQL Server {2008}[http://blogs.msdn.com/b/walzenbach/archive/2010/04/14/how-to-enable-remote-connections-in-sql-server-2008.aspx] and {2012 Express}[http://stackoverflow.com/questions/11278114/enable-remote-connections-for-sql-server-express-2012].  
...
* <em>tsql -S server -U user -P password</em> to connect to SQL Server.  More information on testing is available at http://freetds.schemamania.org/userguide/confirminstall.htm 